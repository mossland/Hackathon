...
import { IRspMetadata, IL7DMetadata, ITicketModel, IHeadsOrTailsMetadata, IPizzaRevolutionMetadata, IGemQuestMetadata, IDoubleDiceMetadata, IDianmondAndBombMetadata, IHorseRaceMetadata, IOneTwoThreeMetadata } from '../model/ticketModel';
...
export const spendByGameId = async (
  ...
  betAmount: Big,
  userId: string,
  resultGenerateFunc: (hash: string) => { meta: IRspMetadata | IL7DMetadata | IHeadsOrTailsMetadata | IPizzaRevolutionMetadata | IGemQuestMetadata | IDoubleDiceMetadata | IDianmondAndBombMetadata | IHorseRaceMetadata | IOneTwoThreeMetadata , payout: number }): Promise<ITicketModel> => {
