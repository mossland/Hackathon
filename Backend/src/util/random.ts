...
import { IRspMetadata, IL7DMetadata, ITicketModel, IHeadsOrTailsMetadata, IPizzaRevolutionMetadata, IGemQuestMetadata, IDoubleDiceMetadata } from '../model/ticketModel';
...
export const spendByGameId = async (
  ...
  betAmount: Big,
  userId: string,
  resultGenerateFunc: (hash: string) => { meta: IRspMetadata | IL7DMetadata | IHeadsOrTailsMetadata | IPizzaRevolutionMetadata | IGemQuestMetadata | IDoubleDiceMetadata, payout: number }): Promise<ITicketModel> => {
