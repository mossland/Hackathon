...
import { IRspMetadata, IL7DMetadata, ITicketModel, IHeadsOrTailsMetadata, IPizzaRevolutionMetadata, IGemQuestMetadata, IDoubleDiceMetadata, IDianmondAndBombMetadata, IHorseRaceMetadata, IOneTwoThreeMetadata, IKenoMetadata } from '../model/ticketModel';
...
export const spendByGameId = async (
  ...
  resultGenerateFunc: (hash: string) => {
     meta: IRspMetadata | IL7DMetadata | IHeadsOrTailsMetadata | IPizzaRevolutionMetadata | IGemQuestMetadata | IDoubleDiceMetadata | IDianmondAndBombMetadata | IHorseRaceMetadata | IOneTwoThreeMetadata | IKenoMetadata
     payout: number }): Promise<ITicketModel> => {
